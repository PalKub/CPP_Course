...
WorkspacePath          :=J:/Programy/CppProjects/Section18
ProjectPath            :=J:/Programy/CppProjects/Section18/ConstructorException
IntermediateDirectory  :=../build-$(WorkspaceConfiguration)/ConstructorException
...
User                   :=paluc
Date                   :=30/09/2025
CodeLitePath           :=J:/Programy/CodeLite
MakeDirCommand         :=mkdir
LinkerName             :=J:/Programy/mingw64/bin/g++.exe
SharedObjectLinkerName :=J:/Programy/mingw64/bin/g++.exe -shared -fPIC
ObjectSuffix           :=.o
DependSuffix           :=
PreprocessSuffix       :=.i
DebugSwitch            :=-g 
...
SourceSwitch           :=-c 
OutputDirectory        :=J:/Programy/CppProjects/Section18/build-$(WorkspaceConfiguration)/bin
...
PCHCompileFlags        :=
RcCmpOptions           := 
RcCompilerName         :=J:/Programy/mingw64/bin/windres.exe
LinkOptions            :=  -static
...
##
AR       := J:/Programy/mingw64/bin/ar.exe -r
CXX      := J:/Programy/mingw64/bin/g++.exe
CC       := J:/Programy/mingw64/bin/gcc.exe
CXXFLAGS :=  -O0 -gdwarf-2 -std=c++17 -Wall $(Preprocessors)
CFLAGS   :=  -gdwarf-2 -O0 -Wall $(Preprocessors)
ASFLAGS  := 
AS       := J:/Programy/mingw64/bin/as.exe


##
## User defined environment variables
##
CodeLiteDir:=J:\Programy\CodeLite
...
$(IntermediateDirectory)/Trust_Account.cpp$(ObjectSuffix): Trust_Account.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/Trust_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Trust_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix): I_Printable.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/I_Printable.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix): Checking_Account.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/Checking_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/main.cpp$(PreprocessSuffix): main.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/main.cpp$(PreprocessSuffix) main.cpp

$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Account.cpp$(PreprocessSuffix): Account.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Account.cpp$(PreprocessSuffix) Account.cpp

$(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix): Savings_Account.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/Savings_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix): Account_Util.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "J:/Programy/CppProjects/Section18/ConstructorException/Account_Util.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix) $(IncludePath)
