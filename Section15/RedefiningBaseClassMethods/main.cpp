...
int main() {
    ...
    cout << s1 << endl; //Savings Account balance: 1000, Intrest rate: 5
    
    s1.deposit(1000);
    cout << s1 << endl; //Savings Account balance: 2050, Intrest rate: 5
    
    s1.withdraw(2000);
    cout << s1 << endl; //Savings Account balance: 50, Intrest rate: 5;
